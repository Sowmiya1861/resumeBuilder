...
function generateCV(){
    ...
    document.getElementById("languageT").innerHTML = document.getElementById("languagek").value;
    // skills
    ...
    document.getElementById('skT').innerHTML = a;
    ...
    document.getElementById('hbT').innerHTML = b;
...
function downloadPage() {
    ...
    doc.html(html, {
      callback: function () {
        // Save the PDF document with the current date and time as the filename
        doc.save("page-" + Date.now() + ".pdf");
      }
    });
  }
